...
class UI(Tk):
	...
	def __init__(self):
		...
		self.maptypes = ['satellite', 'roadmap', 'terrain', 'roadmap2', 'roadsonly', 'terrainonly', 'hybrid']
		...
		self.goompy = GooMPy(WIDTH, HEIGHT, LATITUDE, LONGITUDE, ZOOM, MAPTYPE, None, 4, 1, KMLFILE)
